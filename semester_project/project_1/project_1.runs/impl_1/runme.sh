...
HD_PWD='C:/Xilinx/SST/semester_project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cond_Sum_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cond_Sum_Adder.tcl -notrace
