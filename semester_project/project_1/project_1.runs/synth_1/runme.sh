...
HD_PWD='C:/Xilinx/SST/semester_project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cond_Sum_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cond_Sum_Adder.tcl
