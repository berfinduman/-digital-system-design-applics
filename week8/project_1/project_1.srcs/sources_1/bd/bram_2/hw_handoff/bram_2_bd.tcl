...
################################################################
# This is a generated script based on design: bram_2
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 6 -to 0 addra_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set dina_0 [ create_bd_port -dir I -from 1023 -to 0 dina_0 ]
