...
HD_PWD='C:/Xilinx/SST/week8/project_1/project_1.runs/bram1_blk_mem_gen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram1_blk_mem_gen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram1_blk_mem_gen_1_0.tcl
