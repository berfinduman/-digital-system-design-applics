...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 3 -to 0 addra_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set dina_0 [ create_bd_port -dir I -from 7 -to 0 dina_0 ]
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../../../Users/berfi/Downloads/memory.coe} \
