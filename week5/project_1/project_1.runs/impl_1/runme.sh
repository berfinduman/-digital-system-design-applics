...
HD_PWD='C:/Xilinx/SST/week5/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_bram.tcl -notrace
