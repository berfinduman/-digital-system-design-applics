...
HD_PWD='C:/Xilinx/SST/week5/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bram.tcl
