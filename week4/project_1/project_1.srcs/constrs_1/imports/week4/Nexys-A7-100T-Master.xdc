...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { C_i }]; #IO_L24N_T3_34 Sch=sw[8]
...
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { V }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
...
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { V }]; #IO_L14N_T2_SRCC_14 Sch=led[9]
