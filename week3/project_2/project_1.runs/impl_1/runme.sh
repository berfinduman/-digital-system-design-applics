...
HD_PWD='C:/Xilinx/SST/week3/project_2/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log with_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source with_decoder.tcl -notrace
