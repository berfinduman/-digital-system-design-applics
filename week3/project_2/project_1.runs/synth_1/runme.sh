...
HD_PWD='C:/Xilinx/SST/week3/project_2/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log with_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source with_decoder.tcl
