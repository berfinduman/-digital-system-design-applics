...
HD_PWD='C:/Xilinx/SST/semester_project2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log detect_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source detect_machine.tcl
