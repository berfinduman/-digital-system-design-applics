...
HD_PWD='C:/Xilinx/SST/semester_project2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log detect_machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source detect_machine.tcl -notrace
